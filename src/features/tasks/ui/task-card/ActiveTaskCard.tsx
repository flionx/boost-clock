      ...
      <div className="w-full rounded-lg bg-accent pt-3 px-3 pb-5">
        <div className="flex justify-between relative mb-4">
          <div className="flex items-center gap-[clamp(0.5rem,1.5vw,1rem)] max-w-85/100">
            ...
            <h4
              {...dragHandleProps}
              className="text-[calc(20px+(25-20)*((100vw-375px)/(1440-375)))] w-fit max-w-[clamp(70%,30vw,85%)] xl:max-w-[clamp(70%,35vw,85%)] text-content break-words relative linethrough-text gray-text cursor-grab"
            >
              {task.title}
            </h4>
          </div>
